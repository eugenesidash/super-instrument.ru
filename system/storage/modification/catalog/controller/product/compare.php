...
class ControllerProductCompare extends Controller {
	public function index() {
		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			$cart_btn_class .= $product_info['quantity'] <= 0 && isset($settings['cart_btn_disabled']) ? ' disabled2' : '';
			...
			'cart_btn_disabled' 	=> $product_info['quantity'] <= 0 && isset($settings['cart_btn_disabled']) ? $settings['cart_btn_disabled'] : '',
			'cart_btn_icon_mobile' 	=> $product_info['quantity'] <= 0 && isset($settings['cart_btn_icon_disabled_mobile']) ? $settings['cart_btn_icon_disabled_mobile'] : '',
			'cart_btn_icon' 		=> $product_info['quantity'] > 0 ? $settings[$lang_id]['cart_btn_icon'] : $settings[$lang_id]['cart_btn_icon_disabled'],
			'cart_btn_text' 		=> $product_info['quantity'] > 0 ? $settings[$lang_id]['cart_btn_text'] : $settings[$lang_id]['cart_btn_text_disabled'],
