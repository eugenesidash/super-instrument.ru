...
class ControllerModuleOCFilter extends Controller {
  ...
  public function initialise() {
    ...
    $style = 'catalog/view/theme/unishop/stylesheet/ocfilter/ocfilter.css';
    ...
    if (intval($this->model_catalog_product->getTotalProducts(array('filter_category_id'=>$this->category_id))) and $this->config->get('ocfilter_stock_status')) {
