...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_loading'] = $this->language->get('text_loading');
			...
			$data['show_checkout'] = isset($settings['show_checkout']) ? $settings['show_checkout'] : '';
			
			$data['cart_btn_icon'] = isset($settings[$lang_id]['cart_btn_icon_incart']) ? $settings[$lang_id]['cart_btn_icon'] : '';
			$data['cart_btn_text'] = isset($settings[$lang_id]['cart_btn_text_incart']) ? $settings[$lang_id]['cart_btn_text'] : '';
			
			$data['cart_btn_icon_incart'] = isset($settings[$lang_id]['cart_btn_icon_incart']) ? $settings[$lang_id]['cart_btn_icon_incart'] : '';
			$data['cart_btn_text_incart'] = isset($settings[$lang_id]['cart_btn_text_incart']) ? $settings[$lang_id]['cart_btn_text_incart'] : '';
