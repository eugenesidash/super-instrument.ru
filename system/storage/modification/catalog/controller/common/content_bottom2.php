	...
	public function index() {
		...
		if (VERSION >= 2.2) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/content_bottom2.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/common/content_bottom2.tpl', $data);
			} else {
				return $this->load->view('default/template/common/content_bottom2.tpl', $data);
			}
		}
	}
}