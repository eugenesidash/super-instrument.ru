            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-legacy_description<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?> [legacy]</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][legacy_description]" placeholder="<?php echo $entry_description; ?>" id="input-legacy_description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['legacy_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
