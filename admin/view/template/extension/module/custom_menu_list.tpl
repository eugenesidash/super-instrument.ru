  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo $action_mod; ?>" method="post" enctype="multipart/form-data" id="form_2">
        ...
        <table class="table table-bordered table-hover module-list">
			...
			<input type="text" name="custom_menu_module[<?php echo $language['language_id']; ?>][head]" value="<?php if(isset($custom_menu_module[$language['language_id']]['head'])) { echo $custom_menu_module[$language['language_id']]['head']; } ?>" class="form-control" />
			</div>
			<?php } ?>
			</td>
			<td class="left">
			<select name="custom_menu_module[style]" class="form-control">
	...
	<div class="copyright"><a href="mailto:support@unishop2.ru">support@unishop2.ru</div>
  </div>
</div>
<style>
