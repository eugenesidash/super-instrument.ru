...
class ControllerExtensionModuleCustomMenu extends Controller { 
	...
	public function index() {
		$this->language->load('extension/module/custom_menu');
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->get['module_id'])) {
				$this->response->redirect($this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL'));
			} else {
				$this->response->redirect($this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . $url, 'SSL'));
			}
		}
	...
	protected function getList() {
		...
		if(VERSION >= 2.2) {
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . $url, 'SSL')
   		);
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action_mod'] = $this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action_mod'] = $this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$data['insert'] = $this->url->link('extension/module/custom_menu/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('extension/module/custom_menu/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('extension/module/custom_menu/update', 'token=' . $this->session->data['token'] . '&menu_id=' . $result['menu_id'] . $url, 'SSL')
			);
		...
		$data['lang'] = array_merge($data, $this->language->load('extension/module/custom_menu'));	
		...
		$data['sort_title'] = $this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . '&sort=id.name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . '&sort=i.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		if (VERSION >= 2.2) {
			$this->response->setOutput($this->load->view('extension/module/custom_menu_list', $data));
		} else {
			$this->response->setOutput($this->load->view('extension/module/custom_menu_list.tpl', $data));
		}
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['menu_id'])) {
			$data['action'] = $this->url->link('extension/module/custom_menu/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/module/custom_menu/update', 'token=' . $this->session->data['token'] . '&menu_id=' . $this->request->get['menu_id'] . $url, 'SSL');
		}
		
		$data['cancel'] = $this->url->link('extension/module/custom_menu', 'token=' . $this->session->data['token'] . $url, 'SSL');	
		...
		if (VERSION >= 2.2) {
			$this->response->setOutput($this->load->view('extension/module/custom_menu_form', $data));
		} else {
			$this->response->setOutput($this->load->view('extension/module/custom_menu_form.tpl', $data));
		}
	}
