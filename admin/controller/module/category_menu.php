...
class ControllerModuleCategoryMenu extends Controller {
	...
	public function index() {
		...
		$this->data['entry_horisontal'] = $this->language->get('entry_horisontal');
		$this->data['entry_vertical'] = $this->language->get('entry_vertical');

		$this->data['text_help'] = $this->language->get('text_help');

		$this->data['entry_levels'] = $this->language->get('entry_levels');
		...
		$this->data['entry_subchild'] = $this->language->get('entry_subchild');
