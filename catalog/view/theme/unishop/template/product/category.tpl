			...
			<?php if ($categories) { ?>
				<div class="row">
					<?php foreach ($categories as $category) { ?>
						<div class="category_list <?php echo $subcategory_column; ?>">
							...
							<div class="product-thumb transition">
								...
								<div class="caption">
									...
									<?php if ($product['rating'] >= 0 && $show_rating) { ?>
										...
										<p data-toggle="tooltip" title="" onclick="compare.add('<?php echo $product['product_id']; ?>');" data-original-title="В сравнение">Сравнить</p>
										</div>
									<?php } ?>
