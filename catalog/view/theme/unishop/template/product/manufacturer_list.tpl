<?php echo $header; ?>
<div class="container">
	<ul class="breadcrumb <?php if (in_array('product/manufacturer/', $menu_schema)) { ?>col-md-offset-4 col-lg-offset-3<?php } ?>">
	...
	<div class="row"><?php echo $column_left; ?>
		...
		<?php } else { ?>
			<?php $class = 'col-sm-12'; ?>
		<?php } ?>
		<?php if (in_array('product/manufacturer/', $menu_schema) && !$column_left && $column_right) { $class = 'col-sm-8 col-md-8 col-lg-6 col-md-offset-4 col-lg-offset-3'; } ?>
		<?php if (in_array('product/manufacturer/', $menu_schema) && !$column_left && !$column_right) { $class = 'col-sm-8 col-md-8 col-lg-9 col-md-offset-4 col-lg-offset-3'; } ?>
	    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<?php if ($categories) { ?>
				...
				<?php foreach ($categories as $category) { ?>
					<h2 id="<?php echo $category['name']; ?>" class="heading"><span><?php echo $category['name']; ?></span></h2>
