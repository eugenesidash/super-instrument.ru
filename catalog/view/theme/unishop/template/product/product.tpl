...
<!-- 										<div class="has_link1" onclick="location='http://super-instrument.ru/'">
						...
						<div class="row">
							...
							<?php if ($review_status) { ?>
								...
								<div class="btn-group col-xs-5 col-sm-4 visible-xs visible-sm" id="butnone">
									<button type="button" data-toggle="tooltip" class="btn btn-default" title="Задать вопрос о товаре" onclick="callback('Вопрос', '<?php echo $product_id; ?>');"><i class="fa fa-question"></i></button>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<ul class="nav nav-tabs">
							...
							<?php if (!empty($xspecs)) { ?>
								<li><a href="#tab-xspecs" data-toggle="tab"><i class="fa fa-list-alt" aria-hidden="true"></i><?php echo $tab_attribute; ?></a></li>
							<?php } ?>
							<?php if (!empty($xobtainment)) { ?>
								<li><a href="#tab-xobtainment" data-toggle="tab"><i class="fa fa-file-text-o" aria-hidden="true"></i>Способы получения товара</a></li>
							<?php } ?>
						...
						<div class="tab-content">
							...
							<?php if (!empty($xspecs)) { ?>
							<div class="tab-pane" id="tab-xspecs"><?php echo $xspecs; ?></div>
							<?php } ?>
							<?php if (!empty($xobtainment)) { ?>
							<div class="tab-pane" id="tab-xobtainment"><?php echo $xobtainment; ?></div>
							<?php } ?>
							<?php if ($attribute_groups) { ?>
